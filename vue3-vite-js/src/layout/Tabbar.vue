<template>
	<a-row class="bg-white p-1 border-t border-slate-100 overflow-x-auto scroll-x-bar" align="middle" :wrap="false">
		<a-popover
...
export default defineComponent({
	...
	setup() {
		...
		return {
			...
			onClickTagItem,
			onCloseTagItem,
			onCloseTagItemOnOther,
			onCloseTagItemOnRight,
			onRightClickTagItem,
			onClickTagItemOutside,
		};
	},
});
</script>
